...
@register_model('transformer_rope')
...
class TransformerEncoder(Seq2SeqEncoder):
    ...
    def __init__(self,
        ...
        self.pos_embed = RotaryPositionalEncoding(dim_embed, max_seq_len)
    ...
    def forward(self, input, mask=None):
        ...
        # Output is of shape [batch_size, seq_len, dim_embed]
        x = self.pos_embed(x) # Positional Encoding with RoPE
